...
def get_all_installed_programs_86():
    programs = []
    # nro = 0
...
def get_all_installed_programs():
    programs = []
    # nro = 0
    program_files_dir = "C:\\Program Files"  # Ajusta esto según tu sistema operativo
    for root, dirs, files in os.walk(program_files_dir):
        # nro += 1
        for file in files:
...
if __name__ == "__main__":
    ...
    all_installed_programs_86 = get_all_installed_programs_86()

    all_programs = all_installed_programs + all_installed_programs_86
